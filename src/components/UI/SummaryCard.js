  ...
  return (
    <View style={styles.addressView2}>
      ...
      <View style={styles.textView}>
        {productQuantity && (
          <>
            <Text style={[styles.text1, styles.text2]}>Product Quantity</Text>
            <Text style={[styles.text1, styles.text2]}>{productQuantity}</Text>
          </>
        )}
      </View>
      <View style={styles.textView}>
        {mrpPrice && (
          <>
            ...
            <Text style={[styles.text1, styles.text2]}>{mrpPrice}</Text>
          </>
        )}
      </View>
      <View style={styles.textView}>
      ...
      <View style={styles.textView}>
        {shippingFee && (
          <>
            ...
            <Text style={[styles.text1, styles.text2]}>{shippingFee}</Text>
          </>
        )}
      </View>
      <View style={styles.textView}>
      ...
      <View style={styles.textView}>
        {marginAdded && (
          <>
            ...
            <Text style={styles.marginAdded}>{marginAdded}</Text>
          </>
        )}
      </View>
      {horzLine && <View style={styles.horizonline} />}
    </View>
  );
};
